...
import { Text, View, ScrollView, SafeAreaView, TextInput, Button, Picker, Switch, FlatList,Alert,KeyboardAvoidingView } from 'react-native'
...
class CoreComponent extends Component {
    ...
    onClickMePress = () => {
        Alert.alert('Ini Title',this.state.text)
    }
                ...
                <SafeAreaView>
                    {/* <ScrollView> */}
                        ...
                        <View style={{paddingHorizontal : 13}}>
                            ...
                            <Button title='click me' onPress={this.onClickMePress} />
                        </View>
